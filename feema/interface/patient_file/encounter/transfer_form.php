...
if ($_POST['confirm']) {
  ...
  transferred_to_bed          = '" . add_escape_custom($_POST["adm_new_bed"]) . "',
   ...
   $codetype=9;
    ...
    $row1=sqlStatement("SELECT a.service_id service_id,a.code_type code_type,a.code,a.code_text,b.pr_price from codes a,prices b  where a.id=b.pr_id and a.code_type='".$codetype."' and b.pr_level='standard' and a.code like '".$_POST['adm_new_ward']."%' and b.pr_price!=0");
