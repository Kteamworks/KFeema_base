...
<body class="body_top">
<img src=" <?php echo $GLOBALS['webroot']?>/interface/pic/feema.jpg" style="margin:0px 0px" align="top"/>
<hr>
<center>
...
?>
<img src=" <?php echo $GLOBALS['webroot']?>/interface/pic/feemafooter.jpg" style="margin:0px 0px" align="top"/>
<div id='hideonprint'>
<p>
 ...
 <tr id="tr_radio1"><!-- For radio Insurance -->
  <td class='text' valign="top"  >
   <?php echo htmlspecialchars(xl('Payment against'), ENT_QUOTES); ?>:
    ...
    <td class='text' colspan="2" ><input type="radio" name="radio_type_of_payment" id="radio_type_of_payment_self1" value="cash" checked="checked" onClick="make_visible_row();make_it_hide_enc_pay();cursor_pointer();"/><?php echo htmlspecialchars(xl('Encounter Payment'), ENT_QUOTES); ?><input type="radio" name="radio_type_of_payment" id="radio_type_of_payment4" value="pre_payment" onClick="make_hide_row();"/><?php echo htmlspecialchars(xl('Pre Pay'), ENT_QUOTES); ?></td>
